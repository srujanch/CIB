<div class="topNavSearch actionBar">
	<form action="/portal/site/CIBGlobal/cibglobalsearch/?javax.portlet.tpst=691c26d6ac9b4e7fe7661f44d10909a0_ws_MX&amp;javax.portlet.prp_691c26d6ac9b4e7fe7661f44d10909a0=prv%3D%26cn%3Dy%26viewID%3Drealtime_basic_search_process&amp;javax.portlet.begCacheTok=com.vignette.cachetoken&amp;javax.portlet.endCacheTok=com.vignette.cachetoken" method="post" name="searchform1" id="searchform1">
			...
			<!--input type="hidden" name="OpenText:acib" value="selected" /-->
            <input type="hidden" name="OpenText:CIBGlobal" value="selected" />  
			<input type="hidden" name="OpenText:bPBBCOZA value="selected" />
			<input type="hidden" name="OpenText:coza-PrivateClients" value="selected" />
			<input type="hidden" name="OpenText:sbDotCom" value="selected" />

			<input type="text" onfocus="this.value = ( this.value == this.defaultValue ) ? '' : this.value;return true;" onblur="if(this.value == '') { this.value = 'I am looking for&hellip;'; }" name="cri_restriction_text0" value="I am looking for&hellip;" />
