...
var bf = new Blowfish('1234567');
			
function ValidateForm()
{
	//first trim the two fields to make sure there are no leading or trailing spaces	
	document.Form1.txtLogin2.value = trim(document.Form1.txtLogin2.value);
	document.Form1.txtPass2.value = trim(document.Form1.txtPass2.value);
	
	//next make sure the User ID and password fields aren't blank
	if (document.Form1.txtLogin2.value.length < 4)  
	{  
  ...
  if(document.Form1.liverb.checked == false && document.Form1.demorb.checked == false){
  ...
  //that's it, time to let them in
  return true;
}

//check if cookie exists, if so, populate User ID field
if ((GetCookie('uidlive')) != null && (document.Form1.CustType.value == 'live'))
	{	  
		document.Form1.txtLogin2.value = bf.decrypt(GetCookie('uidlive'));
		document.Form1.store.checked = true;
	}