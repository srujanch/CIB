...
<c:set var="currentPageNo" value="${param.currentPage}"/>
<c:set var="currentPageNo" value="${empty currentPageNo?'':currentPageNo}"/>
<c:set var="tabBody" value="${empty currentPageNo?'tabBody':''}"/>

<div id="${currentChannelFriendlyName}${currentPageNo}" class="${tabBody}">
